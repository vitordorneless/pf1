...
if ($dep_nome !== 'no') {    
    ...
    $confirm0 = $adesao->save($adesao->get_hash_de_vinvulo(), $adesao->get_ip_captura(), 
            $adesao->get_titular_dep(), $adesao->get_cpf_titular(), $dep_cpf, 
            $dep_nome, $dep_email, $dep_nome_mae, $adesao->get_telefone(), $adesao->get_nascimento(), 
            $dep_tel, $dep_sexo, $adesao->get_cep(), $adesao->get_rua(), $adesao->get_bairro(), 
            $adesao->get_numero(), $adesao->get_complemento(), $adesao->get_cidade(), $adesao->get_uf(), 
            $adesao->get_aceite_termos_de_uso(), $adesao->get_hora_entrada_dos_dados(), 
            $adesao->get_hora_entrada_dos_dados(), $adesao->get_localizacao(), $dep_grau_parentesco);
